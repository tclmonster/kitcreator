...
/*
 * Wrapper for Tcl_GetByteArrayFromObj which is a macro in Tcl 9
 * that cgo cannot resolve directly.
 */
static inline unsigned char *Crypto_GetBytesFromObj(Tcl_Interp *interp, Tcl_Obj *objPtr, Tcl_Size *sizePtr) {
 ...
 */
static inline Tcl_Command Crypto_CreateObjCommand(Tcl_Interp *interp, const char *cmdName,
